...
; For usage, see: http://smwc.me/1203169
Divide:
	LDY #$00
	STZ $04 : STZ $06
	LDA $02 : BNE .Continue
...
.Loop
	CPX #$00 : BMI .EndLoop
	LDA $06 : ASL A : STA $06
	LDA $00 : JSR .NewGetBit : ORA $06 : STA $06
	LDA $06 : CMP $02 : BCC .Next
	LDA $06 : SEC : SBC $02 : STA $06
	JSR .NewMultiplyBit : ORA $04 : STA $04
.Next
	DEX : JMP .Loop
.EndLoop
	LDY.b #$00
...
.NewGetBit
	PHX : PHY
	LDY.b #$00
	PHA : TXA : ASL : AND.w #$00FF : TAX : PLA
	AND.w .Look_Table,x : BEQ + : INY
+	TYA : PLY : PLX
	RTS

.NewMultiplyBit
	PHX
	TXA : ASL : AND.w #$00FF : TAX
	LDA .Look_Table,x
	PLX
	RTS
